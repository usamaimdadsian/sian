    ...
    <div class="page">
        <div class="page-inner">
            <header class="page-title-bar">
                ...
                <button type="button" class="btn btn-success btn-floated" onclick="location.href='{{route('admin.user.create')}}'"><span class="fa fa-plus"></span></button>
                ...
                <div class="card card-fluid">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab5">Pending</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content clearfix">
                            <div class="tab-pane active" id="tab1">
                                <div class="text-muted"> Showing 1 to 10 of {{count($active_users)}} entries </div>
                                <div class="table-responsive">
                                    @include('dashboard.user.inc.index-table',['users' => $active_users, 'status' => 1])
                                </div>
                            </div>
                            <div class="tab-pane" id="tab5">
                                <div class="text-muted"> Showing 1 to 10 of {{count($pending_users)}} entries </div>
                                <div class="table-responsive">
                                    @include('dashboard.user.inc.index-table',['users' => $pending_users, 'status' => 5])
                                </div>
                            </div>
                            <div class="tab-pane" id="tab2">
                                <div class="text-muted"> Showing 1 to 10 of {{count($blocked_users)}} entries </div>
                                <div class="table-responsive">
                                    @include('dashboard.user.inc.index-table',['users' => $blocked_users, 'status' => 2])
                                </div>
                            </div>
                            <div class="tab-pane" id="tab3">
                                <div class="text-muted"> Showing 1 to 10 of {{count($suspended_users)}} entries </div>
                                <div class="table-responsive">
                                    @include('dashboard.user.inc.index-table',['users' => $suspended_users, 'status' => 3])
                                </div>
                            </div>
                            <div class="tab-pane" id="tab4">
                                <div class="text-muted"> Showing 1 to 10 of {{count($deleted_users)}} entries </div>
                                <div class="table-responsive">
                                    @include('dashboard.user.inc.index-table',['users' => $deleted_users, 'status' => 4])
                                </div>
                            </div>
                        </div>
