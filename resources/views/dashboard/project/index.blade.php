    ...
    <div class="page">
        <div class="page-inner">
            <header class="page-title-bar">
                ...
                <button type="button" class="btn btn-success btn-floated" onclick="location.href='{{route('admin.project.create')}}'"><span class="fa fa-plus"></span></button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content clearfix">
                            <div class="tab-pane active" id="tab1">
                                <div class="text-muted"> Showing 1 to 10 of {{count($projects)}} entries </div>
                                <div class="table-responsive">
                                    @include('dashboard.project.inc.index-table',['projects' => $projects, 'status' => 1])
                                </div>
                            </div>
                        </div>
