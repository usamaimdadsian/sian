...
<!-- Mirrored from uselooper.com/auth-recovery-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Aug 2020 09:39:05 GMT -->
...
<body>
    ...
    <main class="auth">
        <!-- form -->
        <form class="auth-form auth-form-reflow" method="POST" action="{{ route('password.update') }}">
            @csrf
            <div class="text-center mb-4">
                <div class="mb-4">
                    <img class="rounded" src={{asset("assets/apple-touch-icon.png" alt="" he)}}ight="72">
                </div>
